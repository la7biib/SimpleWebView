...
$(myWindow.document).contents().find('#instruction .content').html(instr1[0]+"<header class='panel-heading'>Réponse juste</header>"+instr1[1]);
//jQuery('#instruction .content').html(instr1[0]+"<header class='panel-heading'>Réponse juste</header>"+instr1[1]);
}
else
{
$(myWindow.document).contents().find('#instruction .content').html("");
}
$(myWindow.document).contents().find('.div_instruction').fadeIn();
}
