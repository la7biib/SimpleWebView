...
(function ($, window, document, undefined) {
    ...
    var settings = {
        ...
        rtcStatusUpdate: {
            ...
            "entry": {
                statusHTML: '' + '<input id="videoChannelInput" style="display:none;" value="'+window.location.href.split(/#/)[1]+'" class="video-channel-input" type="text" placeholder="enter channel name" />',
                statusFx: function ($this, statusType) { // displays channel entry form
                    ...
                    $('#start_chat').mouseup( function () {
					
						$this.opts.currChannelName = chambre; // assign currentChannelName_raw
            ...
            "allow": {
                statusHTML: "Cliquez sur Autoriser",
            ...
            "waiting": {
                statusHTML: " <span class='exit-channel'><a href='#' class='exit-channel-link'><img src='images/phone.png'/></a></span>Patienter...",
                statusFx: function ($this, statusType) { // handle waiting for peer note
                    ...
                    $('a.exit-channel-link').off().on('mousedown', function (e) { 
                        e.preventDefault();
...
//alert(chambre+"aa1"); 
setTimeout(function () {
document.getElementById('videoChannelInput').value=chambre;
                        }, 500);
                    });
            ...
            "connected": {
                statusHTML: '<a id="videoChatHangupButton" class="video-chat-hangup-button"><img src="images/phone.png"/></a>',
                statusFx: function ($this, statusType) { // handle the dis-connect/hang-up button
                    ...
                    $('#videoChatHangupButton').off().on('click', function () {
                        ...
                        onHangUp($this);
						setTimeout(function () {
$this.opts.currChannelName=chambre;
                        }, 500);
                    });
...
*/
    ...
    var disconnectFromSignallingServer = function ($this, callback) {
        if ($this) {
            ...
            $this.opts.currChannelName = window.location.href.split(/#/)[1];
    ...
    var setStatus = function ($this, statusType, theHTML) {
		...
		//alert($this.opts.currChannelName);
    };
