...
function SimpleWebRTC(opts) {
    ...
    var config = this.config = {
            url: 'https://nodevideo.azurewebsites.net/',
...
//if(peer.browserPrefix.indexOf("eleve")!=-1)
//return false;
...
SimpleWebRTC.prototype.getDomId = function (peer) {
    return [peer.id, peer.type, peer.broadcaster ? 'broadcasting' : 'incoming'].join('-');
};
...
Peer.prototype.handleMessage = function (message) {
    ...
    if (message.prefix) this.browserPrefix = message.prefix+"eleve";
