...
//alert('aa');
  ...
  jQuery(this).select();
	...
	{
		jQuery.ajax({
    url : "getsequenceenfant.php?id_comp="+id_comp+"&session="+data1[1]+"&id_eleve="+uid+"&id_cour="+id_cour,
    type: "POST",
    success: function(data, textStatus, jqXHR)
    {
...
//							call('selected', [selected]);
		...
		//alert(opac_ani);
			...
			setTimeout(function() {
				...
				//element.setAttribute('stroke-dasharray', "5, 1, 5, 1");
