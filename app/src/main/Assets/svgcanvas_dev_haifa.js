...
var socket=io.connect("https://skoolandyou.org");
...
// 					newText.textContent = "text";
	...
	socket.on('pushbutton1',function(d){
	$('#'+ d).click();
	});
	//alert(session);
	...
	console.log(data[1]);
	console.log('k');
	var rep_checkbox=data[1].split(';;');
	var i=0;
	jQuery.each(jQuery('#divcours').find('input[type="checkbox"]'), function(key1,val1) {
