...
(function () {
    ...
    svgedit.history.ChangeElementCommand.prototype.unapply = function (a) {
        ...
        for (l in this.oldValues) {
            ...
            else this.elem.removeAttribute(l); if (l == "transform") K = true
        }
        if (!K)
            if (K = svgedit.utilities.getRotationAngle(this.elem)) {
                l = elem.getBBox();
...
$.SvgCanvas = function (a, K) {
    ...
    this.setRotationAngle = function (b, c) {
        ...
        } else i.numberOfItems == 0 && d.removeAttribute("transform"); if (!c) {
                        ...
                        if (t != "")
                            if (t.indexOf("pointer-events") !== 0)
                                if (!(h.localName === "class" && t.indexOf("se_") === 0)) {
                                    ...
                                    } else t = svgedit.units.shortFloat(t); if (Na.apply && b.nodeName === "image" && h.localName === "href" && Na.images && Na.images === "embed") {
                                        var E =
                                            Jb[t];
                                        if (E) t = E
                                    }
    ...
    this.setLayerVisibility = function (b, c) {
        ...
        else return false; if (i == d.getCurrentLayer()) {
            za();
            qa.clear()
        }
        return true
            ...
            if (h != null) {
                ...
                if ((b === "x" || b === "y") && z.indexOf(h.tagName) >= 0) {
                    ...
                    if (q !== String(c)) {
                        ...
                        } else b == "#href" ? lb(h, c) : h.setAttribute(b, c); if (svgedit.browser.isGecko() && h.nodeName === "text" && /rotate/.test(h.getAttribute("transform")))
...
(function () {
    ...
    if (!window.svgEditor) window.svgEditor = function (a) {
        ...
        s.init = function () {
            ...
            else a.pref("bkgd_url") && A(G.bkgd_color, a.pref("bkgd_url")); if (a.pref("img_save")) {
            ...
            var E = function (g, p) {
                ...
                g.each(function () {
                    ...
                    if (!(g == e.size && !p)) {
                        ...
                        D = a("#tool_size_rules");
                        if (D.length) D.empty();
                        else D = a('<style id="tool_size_rules"></style>').appendTo("head"); if (g != "m") {
                            var Q = "";
